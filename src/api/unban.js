...
module.exports = (app) => {
    ...
    app.post(`${BASE}/outbound/unbans`, rateLimit(limits.POST), (req, res) => {
        ...
        APIRecords.send({ type: "POST", endpoint: `${BASE}/outbound/unbans`, payload: JSON.stringify(body) }).catch(console.error);
    ...
    app.get(`${BASE}/outbound/unbans`, rateLimit(limits.DEFAULT), (req, res) => {
        const body = req.body;

        APIRecords.send({ type: "GET", endpoint: `${BASE}/outbound/unbans`, payload: JSON.stringify(body) }).catch(console.error);
    ...
    app.delete(`${BASE}/outbound/unbans/:id`, rateLimit(limits.DEFAULT), (req, res) => {
        ...
        APIRecords.send({ type: "DELETE", endpoint: `${BASE}/outbound/unbans/${id}`, payload: JSON.stringify(body) }).catch(console.error);
