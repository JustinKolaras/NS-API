...
module.exports = (app) => {
    ...
    app.post(`${BASE}/outbound/unbans`, rateLimit(limits.POST), (req, res) => {
        ...
        APIRecords.send({ type: "POST", endpoint: `${BASE}/outbound/unbans`, payload: body.toString() }).catch(console.error);
    ...
    app.get(`${BASE}/outbound/unbans`, rateLimit(limits.DEFAULT), (req, res) => {
        ...
        APIRecords.send({ type: "GET", endpoint: `${BASE}/outbound/unbans`, payload: body.toString() }).catch(console.error);
    ...
    app.delete(`${BASE}/outbound/unbans/:id`, rateLimit(limits.DEFAULT), (req, res) => {
        ...
        APIRecords.send({ type: "DELETE", endpoint: `${BASE}/outbound/unbans/${id}`, payload: body.toString() }).catch(console.error);
